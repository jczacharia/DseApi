...
/// <summary>
/// Represents a Confluence document with its associated metadata, including space information,
/// versioning details, authorship, ancestors, and labels. This class is designed to be used
/// as an OpenAPI component for integration with API documentation and client generation.
/// </summary>
public sealed class ConfluenceDoc : IOpenApiComponent
{
    [Id]
    [Keyword]
    [JsonPropertyName("id")]
