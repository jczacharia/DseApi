...
public static class HealthCheckEndpoints
{
    ...
    private static async Task WriteHealthReport(HttpContext context, HealthReport report)
    {
        ...
        await context.Response.WriteAsJsonAsync(new DseHealthReport(
            ...
            report.Entries.Select(e => new HealthReportEntry(e.Key,
                ...
                e.Value.Data))), JsonDefaults.Pretty);
    }
...
#pragma warning restore S3011
    ...
    {
        private IEndpointConventionBuilder ApplyDefaults(string summary, string description) => builder
            ...
            .AddOpenApiOperationTransformer(async (operation, ctx, ct) =>
            {
                ...
                ctx.Document!.AddComponent(nameof(DseHealthReport),
